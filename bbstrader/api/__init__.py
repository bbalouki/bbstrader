...
>>> from bbstrader.api import Mt5client
>>> # Ensure MetaTrader 5 terminal is running
>>> if Mt5client.is_connected():
...     account_info = Mt5client.get_account_info()
...     print(f"Account Balance: {account_info.balance}")
...     open_positions = Mt5client.get_positions()
...     positions_df = trade_object_to_df(open_positions)
