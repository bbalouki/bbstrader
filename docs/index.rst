.. bd documentation master file, created by
   sphinx-quickstart on Sun Sep 14 10:44:33 2025.
...
.. image:: https://readthedocs.org/projects/bbstrader/badge/?version=latest
   :target: https://bbstrader.readthedocs.io/en/latest/?badge=latest
   :alt: Documentation Status

.. image:: https://img.shields.io/pypi/v/bbstrader
   :target: https://pypi.org/project/bbstrader/
   :alt: PYPI Version

.. image:: https://img.shields.io/pypi/status/bbstrader.svg?maxAge=60
   :target: https://pypi.python.org/pypi/bbstrader
   :alt: PyPi status

.. image:: https://img.shields.io/pypi/pyversions/bbstrader
   :target: https://pypi.org/project/bbstrader/
   :alt: Supported Python Versions

.. image:: https://static.pepy.tech/badge/bbstrader
   :target: https://pepy.tech/projects/bbstrader
   :alt: PyPI Downloads

.. image:: https://www.codefactor.io/repository/github/bbalouki/bbstrader/badge
   :target: https://www.codefactor.io/repository/github/bbalouki/bbstrader
   :alt: CodeFactor
...
.. image:: https://img.shields.io/badge/PayPal%20Me-blue?logo=paypal
   :target: https://paypal.me/bertinbalouki?country.x=SN&locale.x=en_US
   :alt: PayPal Me
...
You can read the full documentation `here <https://bbstrader.readthedocs.io/en/latest/index.html>`_.
...
.. note::
   ...
   ``bbstrader``'s ``metatrader`` module and execution scripts abstract this process, using configured credentials and settings.
...
.. image:: https://github.com/bbalouki/bbstrader/blob/main/assets/bbs_.png?raw=true
   :alt: Backtesting Results 1

.. image:: https://github.com/bbalouki/bbstrader/blob/main/assets/qs_metrics_1.png?raw=true
   :alt: Backtesting Results 2

.. image:: https://github.com/bbalouki/bbstrader/blob/main/assets/qs_metrics_2.png?raw=true
   :alt: Backtesting Results 3

.. image:: https://github.com/bbalouki/bbstrader/blob/main/assets/qs_plots_1_.png?raw=true
   :alt: Backtesting Results 4

.. image:: https://github.com/bbalouki/bbstrader/blob/main/assets/qs_plots_2_.png?raw=true
   :alt: Backtesting Results 5
...
**`View the Full Documentation on ReadTheDocs`_**
...
.. _Report an Issue on GitHub: https://github.com/bbalouki/bbstrader/issues
.. _Request a Feature on GitHub: https://github.com/bbalouki/bbstrader/issues
